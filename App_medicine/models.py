...
class Company(models.Model):
    ...
    pharmacy_id = models.ForeignKey(Admin, on_delete=models.CASCADE, related_name='company_admin')
    ph_manager_id = models.ForeignKey(Manager, on_delete=models.CASCADE, related_name='company_manager')
    ph_employee_id = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name='company_employee')
    name = models.CharField(max_length=255, verbose_name='Company Name')
    lic_no = models.CharField(max_length=300, verbose_name='License Number')
    address = models.CharField(max_length=300, verbose_name='Company Headquarter Address')
    cont_num = models.CharField(max_length=264, verbose_name='Company Contact Information')
...
class MedicineProduct(models.Model):
    id = models.AutoField(primary_key=True, verbose_name='Serial Number')
    company_id = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='company_medicine')
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='medicine_user')
    pharmacy_id = models.ForeignKey(Admin, on_delete=models.CASCADE, related_name='medicine_admin')
    ph_manager_id = models.ForeignKey(Manager, on_delete=models.CASCADE, related_name='medicine_manager')
    ph_employee_id = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name='medicine_employee')
    name = models.CharField(max_length=300, verbose_name='Medicine Name', null=True)
    m_type = models.CharField(max_length=300, verbose_name='Which type of Medicine', null=True)
    des = models.TextField(max_length=500, verbose_name='Medicine Description', null=True)
    b_no = models.CharField(max_length=100, verbose_name='Batch No', null=True)
...
class Sale(models.Model):
    item = models.ForeignKey(MedicineProduct, on_delete=models.CASCADE)
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='sale_user')
    pharmacy_id = models.ForeignKey(Admin, on_delete=models.CASCADE, related_name='sale_admin')
    ph_manager_id = models.ForeignKey(Manager, on_delete=models.CASCADE, related_name='sale_manager')
    ph_employee_id = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name='sale_employee')
    quantity = models.IntegerField(default=0, null=True, blank=True)
    amount_received = models.IntegerField(default=0, null=True, blank=True)
    unit_price = models.IntegerField(default=0, null=True, blank=True)
